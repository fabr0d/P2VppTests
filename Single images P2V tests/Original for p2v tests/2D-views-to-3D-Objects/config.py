...
#__C.DATASETS.INFERENCE.TAXONOMY_FILE_PATH    = '/content/drive/MyDrive/00Pix2Vox00/Shapenet2dto3d/datasets/DemoDataPieza0.json'
#__C.DATASETS.INFERENCE.TAXONOMY_FILE_PATH    = '/content/drive/MyDrive/00Pix2Vox00/Shapenet2dto3d/datasets/DemoDataPieza1.json'
__C.DATASETS.INFERENCE.TAXONOMY_FILE_PATH    = '/content/drive/MyDrive/00Pix2Vox00/Shapenet2dto3d/datasets/DemoDataPieza2.json'

__C.DATASETS.INFERENCE.RENDERING_PATH        = '/content/drive/MyDrive/00Pix2Vox00/Shapenet2dto3d/datasets/DemoImage/%s/%s/rendering/%02d.png'
