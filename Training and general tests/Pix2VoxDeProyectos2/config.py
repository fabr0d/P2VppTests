...
__C.DATASETS.SHAPENET.TAXONOMY_FILE_PATH    = '/content/drive/MyDrive/00Pix2Vox00/Pix2Vox/PropioDS/REAL.json'
__C.DATASETS.SHAPENET.RENDERING_PATH        = '/content/drive/MyDrive/00Pix2Vox00/Pix2Vox/PropioDS/DemoImage/%s/%s/rendering/%02d.png'
__C.DATASETS.SHAPENET.VOXEL_PATH            = '/content/drive/MyDrive/00Pix2Vox00/Pix2Vox/PropioDS/DemoImage/%s/%s/model.binvox'
