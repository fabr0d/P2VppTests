...
def test_net(cfg,
    ...
    for sample_idx, (taxonomy_id, sample_name, rendering_images, ground_truth_volume) in enumerate(test_data_loader):
        ...
        with torch.no_grad():
            ...
            output_dir = '/content/drive/MyDrive/00Pix2Vox00/TestsP2V/Pix2Vox/output'
            #print('######### ' + output_dir + ' #########')
            ...
            if output_dir and sample_idx < 3:
                ...
                rendering_views = utils.binvox_visualization.get_volume_views(gv, os.path.join(img_dir, 'testgv'), epoch_idx)
                #test_writer.add_image('Test Sample#%02d/Volume Reconstructed' % sample_idx, rendering_views, epoch_idx)

                gtv = ground_truth_volume.cpu().numpy()
                rendering_views = utils.binvox_visualization.get_volume_views(gtv, os.path.join(img_dir, 'testgtv'), epoch_idx)
    ...
    print('# of views : ' + str(cfg.CONST.N_VIEWS_RENDERING))
