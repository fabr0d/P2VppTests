...
#confondo
__C.DATASETS.SHAPENET.TAXONOMY_FILE_PATH    = '/content/drive/MyDrive/00Pix2Vox00/Pix2Vox/PropioDS/MODS.json'
__C.DATASETS.SHAPENET.RENDERING_PATH        = '/content/drive/MyDrive/00Pix2Vox00/Pix2Vox/PropioDS/imagesConFondo/%s/%s/rendering/%02d.png'
__C.DATASETS.SHAPENET.VOXEL_PATH            = '/content/drive/MyDrive/00Pix2Vox00/Pix2Vox/PropioDS/imagesConFondo/%s/%s/model.binvox'
...
#__C.CONST.WEIGHTS                           = '/content/drive/MyDrive/00Pix2Vox00/Pix2Vox/output/ckpt-epoch-0100.pth'
